...
**✅ Покрытие символов:** 100% основных функций Tor - ВСЕ symbols resolved! (v1.0.41 - FULL Simulator Support!)
...
**✅ v1.0.41:** ПОЛНАЯ поддержка Device И Simulator! Использует vtool для изменения platform device binary (2→7), работает стабильно на обоих платформах!
