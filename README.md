...
**✅ Покрытие символов:** 100% основных функций Tor - ВСЕ symbols resolved! (v1.0.42 - Restored Working v1.0.36!)
...
**✅ v1.0.42:** Восстановлена РАБОЧАЯ v1.0.36! Device (platform 2) + Simulator (platform 7) работают стабильно! НЕТ изменений в build скриптах!
