...
**✅ Покрытие символов:** 100% основных функций Tor - ВСЕ symbols resolved! (v1.0.39 - Simulator Support!)
...
**✅ v1.0.39:** Полная поддержка iOS Simulator! XCFramework содержит оба slices (device + simulator) с правильным Info.plist!
